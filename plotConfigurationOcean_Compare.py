...
if create_folder:
    ...
    mainVfolder = main_dir + "Visualization_" + str(folder_title) + "/"
    #mainVfolder = "./Visualization_" + str(folder_title) + "/"
    if year == 2020:
...
mainOutputfolder_BF2018 = "./Output/SeaIce2018_" + str(280) + "/"
mainOutputfolder_HM2018 = "./Output/SeaIce2018_" + str(1348) + "/"  #high melt is now Low Break
mainOutputfolder_HB2018 = "./Output/SeaIce2018_" + str(315) + "/"
mainOutputfolder_BF2020 = "./Output/SeaIce2020_" + str(300) + "/"
...
if year == 2018:
    ...
    inputFolder0 = "./Input/SeaIceWGJ2020/"
...
inputFolder2020 = "./Input/SeaIceWGJ2020/"
dataGSDFile2020 = inputFolder2020 + "GSD_FinalResults2020.dat" #Source: MODIS Data #v1 modified with different days 2020
dataTempFile2020 = inputFolder2020 + "Temp_data.dat"  #Source: Copernicus Data
dataThickFile2020 = inputFolder2020 + "Thick_data.dat"  #Source: Copernicus Data
dataConcV2020            = np.loadtxt(dataGSDFile2020)
dataTempV2020            = np.loadtxt(dataTempFile2020)
dataThickV2020            = np.loadtxt(dataThickFile2020)

# Output contact and updated position file
figDir              = mainVfolder
figDir4             = mainOutputfolder+"GSD/"
...
concFile_BF2018         = mainOutputfolder_BF2018+"normConc0.dat"
concFile_HM2018         = mainOutputfolder_HM2018+"normConc0.dat"
concFile_HB2018         = mainOutputfolder_HB2018+"normConc0.dat"
concFile_BF2020         = mainOutputfolder_BF2020+"normConc0.dat"
...
concV_BF2018            = np.loadtxt(concFile_BF2018)
concV_HB2018            = np.loadtxt(concFile_HB2018)
concV_HM2018            = np.loadtxt(concFile_HM2018)
concV_BF2020            = np.loadtxt(concFile_BF2020)
...
def write_img(step):
    ...
    #                print("No intersection")
        ...
        pCol_sel = PatchCollection(patches_sel, facecolors='white',edgecolors='black', lw=0.1) #red
        ax.add_collection(pCol_sel)
        pCol_sel2 = PatchCollection(patches_sel2, facecolors='white',edgecolors='black', lw=0.1) #pink
...
plt.plot(t_gsd, slope_NF_data, 'r', marker='s', fillstyle='none', label='Sea Ice F. Count Slopet: Data') #Same Size Data
...
#Save Conc. and Normalized Area BF2018
timeC_BF2018 = []
nArea_BF2018 = []
Conc_BF2018 = []
ConcB_BF2018 = []
...
surfArea_BF2018 = []
aveThick_BF2018 = []
globalOceanTemp_BF2018 = []
aveThickC_BF2018 = []
aveThickF_BF2018 = []
for i in range(len(concV_BF2018)):
    timeC_BF2018.append(concV_BF2018[i][0])
    nArea_BF2018.append(concV_BF2018[i][1])
    Conc_BF2018.append(concV_BF2018[i][2]*100)
    ConcB_BF2018.append(concV_BF2018[i][3]*100)
    ConcF_BF2018.append(concV_BF2018[i][4]*100)
    surfArea_BF2018.append(concV_BF2018[i][5])
    aveThick_BF2018.append(concV_BF2018[i][6])
    globalOceanTemp_BF2018.append(concV_BF2018[i][7])
    aveThickC_BF2018.append(concV_BF2018[i][8])
    aveThickF_BF2018.append(concV_BF2018[i][9])

#Save Conc. and Normalized Area HB2018
timeC_HB2018 = []
nArea_HB2018 = []
Conc_HB2018 = []
ConcB_HB2018 = []
...
surfArea_HB2018 = []
aveThick_HB2018 = []
globalOceanTemp_HB2018 = []
aveThickC_HB2018 = []
aveThickF_HB2018 = []
for i in range(len(concV_HB2018)):
    timeC_HB2018.append(concV_HB2018[i][0])
    nArea_HB2018.append(concV_HB2018[i][1])
    Conc_HB2018.append(concV_HB2018[i][2]*100)
    ConcB_HB2018.append(concV_HB2018[i][3]*100)
    ConcF_HB2018.append(concV_HB2018[i][4]*100)
    surfArea_HB2018.append(concV_HB2018[i][5])
    aveThick_HB2018.append(concV_HB2018[i][6])
    globalOceanTemp_HB2018.append(concV_HB2018[i][7])
    aveThickC_HB2018.append(concV_HB2018[i][8])
    aveThickF_HB2018.append(concV_HB2018[i][9])

#Save Conc. and Normalized Area HM2018
timeC_HM2018 = []
nArea_HM2018 = []
Conc_HM2018 = []
ConcB_HM2018 = []
...
surfArea_HM2018 = []
aveThick_HM2018 = []
globalOceanTemp_HM2018 = []
aveThickC_HM2018 = []
aveThickF_HM2018 = []
for i in range(len(concV_HM2018)):
    timeC_HM2018.append(concV_HM2018[i][0])
    nArea_HM2018.append(concV_HM2018[i][1])
    Conc_HM2018.append(concV_HM2018[i][2]*100)
    ConcB_HM2018.append(concV_HM2018[i][3]*100)
    ConcF_HM2018.append(concV_HM2018[i][4]*100)
    surfArea_HM2018.append(concV_HM2018[i][5])
    aveThick_HM2018.append(concV_HM2018[i][6])
    globalOceanTemp_HM2018.append(concV_HM2018[i][7])
    aveThickC_HM2018.append(concV_HM2018[i][8])
    aveThickF_HM2018.append(concV_HM2018[i][9])


#Save Conc. and Normalized Area BF2020
timeC_BF2020 = []
nArea_BF2020 = []
Conc_BF2020 = []
ConcB_BF2020 = []
...
surfArea_BF2020 = []
aveThick_BF2020 = []
globalOceanTemp_BF2020 = []
aveThickC_BF2020 = []
aveThickF_BF2020 = []
for i in range(len(concV_BF2020)):
    timeC_BF2020.append(concV_BF2020[i][0])
    nArea_BF2020.append(concV_BF2020[i][1])
    Conc_BF2020.append(concV_BF2020[i][2]*100)
    ConcB_BF2020.append(concV_BF2020[i][3]*100)
    ConcF_BF2020.append(concV_BF2020[i][4]*100)
    surfArea_BF2020.append(concV_BF2020[i][5])
    aveThick_BF2020.append(concV_BF2020[i][6])
    globalOceanTemp_BF2020.append(concV_BF2020[i][7])
    aveThickC_BF2020.append(concV_BF2020[i][8])
    aveThickF_BF2020.append(concV_BF2020[i][9])
...
timeCData2020 = np.zeros(len(dataConcV2020))
dataConcC2020  = np.zeros(len(dataConcV2020))
dataConcF2020  = np.zeros(len(dataConcV2020))
dataConcT2020  = np.zeros(len(dataConcV2020))

for i in range(len(timeCData2020)):
    timeCData2020[i]    = dataConcV2020[i][0]
    dataConcC2020[i]    = dataConcV2020[i][5]
    dataConcF2020[i]    = dataConcV2020[i][6]
    dataConcT2020[i]    = dataConcV2020[i][4]


#NEWISH: Compare plots:

dataTemp = np.zeros(len(timeC_BF2018))
for i in range(len(timeC)):
    dataTemp[i] = dataTempV[i][1]

dataTemp2020 = np.zeros(len(dataTempV2020)) 
for i in range(len(dataTempV2020)):
    dataTemp2020[i] = dataTempV2020[i][1]

#2018
#Plot Sim Temp vs. Field Data Temp (Temperatures 2018)
figGAT = plt.figure(figsize=(10,10))
plt.xlabel('Time (days)', fontsize = 20)
plt.ylabel('Temperature (Celsius)', fontsize = 20)
plt.tick_params(axis='x', labelsize=15)
plt.tick_params(axis='y', labelsize=15)
plt.plot(timeC_BF2018, dataTemp,'k-', marker='s', label='Observations') #Same Size Data
plt.plot(timeC_BF2018,globalOceanTemp_BF2018,'ko', label='Best Fit Sim.')
plt.plot(timeC_BF2018,globalOceanTemp_HB2018,'b*', label='High Break Sim.')
plt.plot(timeC_BF2018,globalOceanTemp_HM2018,'r*', label='Low Break Sim.')
plt.legend(prop={'size': 20})
plt.title('Evolution of Average Ocean Temperature', fontsize = 25)
plt.savefig(figDir8 + 'SeaIce_AveOceanTemp_CompareMulti2018.png', format='png')
plt.close()

#Plot simpler Image (Thickness 2018)
figGAT = plt.figure(figsize=(10,10))
...
for i in range(len(timeC)):
    dataThick[i] = dataThickV[i][1]
plt.plot(timeC_BF2018, dataThick,'k-', marker='s', label='Observations') #Same Size Data
plt.plot(timeC_BF2018,aveThick_BF2018,'ko', label='Best Fit Sim.')
plt.plot(timeC_BF2018,aveThick_HB2018,'b*', label='High Break Sim.')
plt.plot(timeC_BF2018,aveThick_HM2018,'r*', label='Low Break Sim.')
plt.legend(prop={'size': 20})
plt.title('Evolution of Average Thickness', fontsize = 25)
plt.savefig(figDir8 + 'SeaIce_AveThick_CompareTotMulti2018.png', format='png')
plt.close()

#Plot Only Coarse Concentration Performance (Coarse Conc. 2018)
figG3 = plt.figure(figsize=(10,10))
plt.plot(timeCData, dataConcC, 'k-', marker='s', fillstyle='none', label='Observations') #Same Size Data
plt.plot(timeC_BF2018,ConcB_BF2018, 'ko', label='Best Fit Sim.')
plt.plot(timeC_BF2018,ConcB_HB2018, 'b*', label='High Break Sim.')
plt.plot(timeC_BF2018,ConcB_HM2018, 'r*', label='Low Break Sim.')
plt.xlabel('Time (days)', fontsize = 20)
plt.ylabel('Sea Ice Concentration (%)', fontsize = 20)
plt.tick_params(axis='x', labelsize=15)
plt.tick_params(axis='y', labelsize=15)
plt.legend(prop={'size': 20})
plt.title('Evolution of Sea Ice Concentration: Coarse', fontsize = 25)
plt.savefig(figDir8 + 'SeaIce_Concentration_CompareCMulti2018.png', format='png')
plt.close()
...
plt.tick_params(axis='x', labelsize=15)
plt.tick_params(axis='y', labelsize=15)
plt.plot(timeC_BF2018, dataTemp,'k-', marker='s', label='Observations 2018') #Same Size Data
plt.plot(timeC_BF2018,globalOceanTemp_BF2018,'ko', label='Best Fit Sim. 2018')
plt.plot(timeC_BF2020, dataTemp2020,'b-', marker='s', label='Observations 2020') #Same Size Data
plt.plot(timeC_BF2020,globalOceanTemp_BF2020,'bo', label='Best Fit Sim. 2020')
plt.legend(prop={'size': 20})
plt.title('Evolution of Average Ocean Temperature', fontsize = 25)
plt.savefig(figDir8 + 'SeaIce_AveOceanTemp_CompareMulti2018vs2020.png', format='png')
plt.close()
...
plt.tick_params(axis='x', labelsize=15)
plt.tick_params(axis='y', labelsize=15)
dataThick = np.zeros(len(timeC_BF2018))
dataThick2020 = np.zeros(len(timeC_BF2020))
for i in range(len(timeC_BF2018)):
    dataThick[i] = dataThickV[i][1]
for i in range(len(timeC_BF2020)):
    dataThick2020[i] = dataThickV2020[i][1]
plt.plot(timeC_BF2018, dataThick,'k-', marker='s', label='Observations 2018') #Same Size Data
plt.plot(timeC_BF2018,aveThick_BF2018,'k*', label='Best Fit Sim. 2018')
plt.plot(timeC_BF2020, dataThick2020,'b-', marker='s', label='Observations 2020') #Same Size Data
plt.plot(timeC_BF2020,aveThick_BF2020,'b*', label='Best Fit Sim. 2020')
plt.legend(prop={'size': 20})
plt.title('Evolution of Average Thickness', fontsize = 25)
plt.savefig(figDir8 + 'SeaIce_AveThick_CompareTotMulti2018vs2020.png', format='png')
plt.close()

#Plot Only Coarse Concentration Performance (Coarse Conc. 2018)
figG3 = plt.figure(figsize=(10,10))
plt.plot(timeCData, dataConcC,'k-', marker='s', fillstyle='none', label='Observations 2018') #Same Size Data
plt.plot(timeC_BF2018, ConcB_BF2018,'k*', label='Best Fit Sim. 2018')
plt.plot(timeCData2020, dataConcC2020,'b-', marker='s', fillstyle='none', label='Observations 2020') #Same Size Data
plt.plot(timeC_BF2020, ConcB_BF2020,'b*', label='Best Fit Sim. 2020')
plt.xlabel('Time (days)', fontsize = 20)
plt.ylabel('Sea Ice Concentration (%)', fontsize = 20)
plt.tick_params(axis='x', labelsize=15)
plt.tick_params(axis='y', labelsize=15)
plt.legend(prop={'size': 20})
plt.title('Evolution of Sea Ice Concentration: Coarse', fontsize = 25)
plt.savefig(figDir8 + 'SeaIce_Concentration_CompareCMulti2018vs2020.png', format='png')
plt.close()
